...
практика від Лекції 3 і до самого кінця працюватиме саме з
...
Шарадкін Д.М., Субач І.Ю., Микитюк А.В. *Інструментальні засоби Python для моделювання та системного аналізу часових рядів при вирішенні задач кіберзахисту інформаційно-комунікаційних систем.* — Київ: ІСЗЗІ КПІ ім. Ігоря Сікорського, 2023 ([відкритий доступ](https://ela.kpi.ua/bitstream/123456789/52426/1/Instrumentalni_zasoby_Python_2023.pdf)). Підрозділ 3.4 «Робота з часом та датами в pandas» і розділ 7 «Введення та виведення даних при роботі з модулем pandas» — робота з DataFrame.

Семенович К.О., Лавренюк М.В., Пришляк О.О. *Основи візуалізації наукових даних: Конспект лекцій з курсу «Візуалізація даних».* — Київ: Київський національний університет імені Тараса Шевченка (мех.-мат. ф-т, каф. комп'ютерних методів механіки і процесів керування), 2024 ([відкритий доступ](https://mechmat.knu.ua/wp-content/uploads/2024/05/elektronnyj-konspekt-lektsij-z-kursu-vizualizatsiia-danykh_osnovy-vizualizatsii-naukovykh-danykh.pdf)). Розділ 5 «Читання й підготовка даних із pandas» у контексті наукової візуалізації — практичні приклади роботи з DataFrame.
