...
**Чому це важливо не тільки в теорії.** У Лекції 6 (частотний розподіл) і
Лекції 7 (міри розсіювання й форма розподілу) вибір статистики й графіка
...
стовпців. Це стане особливо наочним у Лекції 9 (групування і зведені
...
Шелестов А.Ю., Куссуль Н.М. *Засоби підготовки та аналізу даних: Лабораторний практикум.* — Київ: КПІ ім. Ігоря Сікорського, 2021 ([відкритий доступ](https://ela.kpi.ua/items/22730a6d-f9d1-4b97-8d4c-8764bcaf3590)). Немає окремого україномовного підручника з концепції tidy data (Wickham); використано розділ про підготовку й валідацію наборів даних як найближчий за змістом (структурування даних перед аналізом).

Шарадкін Д.М., Субач І.Ю., Микитюк А.В. *Інструментальні засоби Python для моделювання та системного аналізу часових рядів при вирішенні задач кіберзахисту інформаційно-комунікаційних систем.* — Київ: ІСЗЗІ КПІ ім. Ігоря Сікорського, 2023 ([відкритий доступ](https://ela.kpi.ua/bitstream/123456789/52426/1/Instrumentalni_zasoby_Python_2023.pdf)). Розділ 7 (введення/виведення в pandas, побудова DataFrame) непрямо стосується структурування («охайності») табличних даних.
