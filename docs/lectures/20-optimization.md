...
*Лекція 19 класифікувала математичні моделі за типом задачі, яку вони
...
Лекції 11, лише інший підмодуль: тут зібрані алгоритми для задач
...
що лежить в основі методу найменших квадратів із Лекції 18, лише без
...
Ладогубець Т.С., Фіногенов О.Д. *Лінійне програмування: практикум з дисципліни «Методи оптимізації».* — Київ: КПІ ім. Ігоря Сікорського, 2019 ([відкритий доступ](https://ela.kpi.ua/items/d4b8f40e-97d5-4c76-8c88-323942b43088)). Профільний практикум з лінійного програмування: побудова лінійних моделей, графічний метод, симплекс-метод, метод штучного базису.

Ладієва Л.Р. *Методи оптимізації та пошуку оптимальних рішень.* — Київ: КПІ ім. Ігоря Сікорського, 2023 ([відкритий доступ](https://ela.kpi.ua/server/api/core/bitstreams/fc12de96-2f86-4500-b615-1056c0d6e00e/content)). Ширший курс методів оптимізації: класичні методи екстремумів, лінійне та цілочислове програмування, множники Лагранжа, градієнтні методи.
