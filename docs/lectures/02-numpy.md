...
(Лекція 3), Matplotlib (Лекція 7), SciPy (Лекції 11, 20) і statsmodels
(Лекція 18) усі внутрішньо зберігають дані саме в масивах NumPy й
...
Парненко В.С. *Мова програмування Python. NumPy в Python (навчально-методичні матеріали).* — Київ: КПІ ім. Ігоря Сікорського (каф. конструювання машин, ННІ ММІ), 2023 ([відкритий доступ](https://ela.kpi.ua/items/fba3621a-09ab-4f4a-8af0-2331e953ef94)). Профільний матеріал саме про NumPy: створення масивів, векторизовані операції, broadcasting, агрегатні функції, матричні операції.

Шарадкін Д.М., Субач І.Ю., Микитюк А.В. *Інструментальні засоби Python для моделювання та системного аналізу часових рядів при вирішенні задач кіберзахисту інформаційно-комунікаційних систем.* — Київ: ІСЗЗІ КПІ ім. Ігоря Сікорського, 2023 ([відкритий доступ](https://ela.kpi.ua/bitstream/123456789/52426/1/Instrumentalni_zasoby_Python_2023.pdf)). Підрозділ 3.3 «Робота з часом і датами в numpy» + розділ 4 «Засоби Python для описової статистики» — практичне застосування NumPy для обчислень.
